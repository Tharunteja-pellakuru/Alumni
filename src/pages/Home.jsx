...
import { featuredAlumni, upcomingEvents, alumniStories, galleryImages } from '../data/dummyData';
      ...
      <section className="relative h-[600px] md:h-[700px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-school-blue mb-8 font-medium">
            Connecting our esteemed alumni to their alma mater and to each other.
          </p>
          <button
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
              ...
              <div className="text-center">
                <div className="flex justify-center mb-4">
                  <div className="w-16 h-16 border-2 border-school-orange rounded-full flex items-center justify-center">
                    <svg className="w-8 h-8 text-school-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    </svg>
                  </div>
                </div>
                <h3 className="text-xl font-bold text-school-blue mb-3">Alumni Directory</h3>
                <p className="text-gray-600 text-sm leading-relaxed">
                  Explore the profiles of notable alumni and reconnect with your classmates.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-school-blue mb-3">Upcoming Events</h3>
                <p className="text-gray-600 text-sm leading-relaxed">
                  Stay informed about upcoming recitations, networking events, and more.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-school-blue mb-3">Alumni Stories</h3>
                <p className="text-gray-600 text-sm leading-relaxed">
                  Read engaging stories and updates from our distinguished alumni.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Kakatiya School of Excellence has been a beacon of quality education, nurturing 
                students to excel in their chosen fields. Our alumni network represents the success 
                stories of our institution, connecting graduates across generations and professions.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Through this portal, we aim to strengthen the bond between our esteemed alumni and 
                their alma mater, fostering a community that continues to grow, learn, and contribute 
                to society together.
              </p>
            </div>
              ...
              >
                <div className="p-6 text-center">
                  ...
                  <h3 className="text-xl font-bold text-school-blue mb-2">
                    {alumni.name.split(' ')[0]} {alumni.name.split(' ')[1]?.charAt(0)}.
                  </h3>
